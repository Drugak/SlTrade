...
class SecuritieWidget extends StatelessWidget {
  ...
  final String tikerName;
  final String fullName;
  final String bid;
  final dynamic bidPercentage;
  final String ask;
  final dynamic askPercentage;
  final bool fullVersion;

  @override
  Widget build(BuildContext context) {
    isPositive(value) {
      if (value == null) return TextStyle(fontSize: 12.0, color: Colors.black);
    ...
    final textBigStyle = TextStyle(fontSize: 16.0, fontWeight: FontWeight.w500);
    final textSmallStyle =
        TextStyle(fontSize: 12.0, color: Color.fromRGBO(21, 21, 24, 0.6));
