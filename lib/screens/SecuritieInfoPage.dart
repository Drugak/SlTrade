         ...
         */
          ...
          */
                Column(
                  ...
                  Row(
                    children: <Widget>[
                      Text(widget.secureInfo['bid'], style: almostBigTextStyle),
                      BidAskDeltaWidget(delta: widget.secureInfo['bidPercentage'])
                    ],
                  ),
                ]),
                /**
          ...
          */
                Column(
                  ...
                  Row(
                    children: <Widget>[
                      Text(widget.secureInfo['ask'], style: almostBigTextStyle),
                      BidAskDeltaWidget(delta: widget.secureInfo['askPercentage'])
                    ],
                  ),
                ]),
              ],
